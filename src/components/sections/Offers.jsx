...
const offers = [
  {
    id: 1, type: 'exchange',
    title: 'Exchange Offer', headline: 'Upgrade Your Old Bike',
    desc: 'Get up to ₹8,000 extra on your old bike when you exchange for a new Hero. Valid on select models.',
    saving: '₹8,000', savingLabel: 'Extra Exchange Bonus',
    badge: 'Most Popular', bg: '#CC0000',
  ...
  {
    id: 2, type: 'finance',
    title: 'Zero Down Payment', headline: 'Ride Today, Pay Later',
    desc: 'Book your Hero bike with zero down payment. Instant loan approval in just 10 minutes.',
    saving: '₹0 Down', savingLabel: 'Down Payment',
    badge: 'Limited Time', bg: '#1A1A1A',
  ...
  {
    id: 3, type: 'cashback',
    title: 'Festival Cashback', headline: '₹5,000 Direct Cashback',
    desc: 'Get ₹5,000 cashback directly in your account on purchase of any Hero bike above ₹85,000.',
    saving: '₹5,000', savingLabel: 'Direct Cashback',
    badge: 'Festival Special', bg: '#CC0000',
    validity: 'Valid till 30 Apr 2025',
  ...
  {
    id: 4, type: 'insurance',
    title: 'Free Insurance', headline: '1-Year Free Insurance',
    desc: 'Get complimentary 1st year comprehensive insurance on all new Hero bike purchases. Save up to ₹3,500.',
    saving: '₹3,500', savingLabel: 'Insurance Value',
    badge: 'Free Add-on', bg: '#1A1A1A',
  ...
  {
    id: 5, type: 'service',
    title: 'Free Service Pack', headline: '3 Free Services + AMC',
    desc: 'Buy any Hero bike and get 3 free services (up to 3,000 km each) + Annual Maintenance Contract worth ₹2,000.',
    saving: '₹4,500', savingLabel: 'Service Value',
    badge: 'Value Pack', bg: '#8B0000',
  ...
  {
    id: 6, type: 'referral',
    title: 'Refer & Earn', headline: 'Earn ₹1,500 Per Friend',
    desc: 'Refer a friend who buys a Hero bike from us and earn ₹1,500 cash reward. No limit on referrals!',
    saving: '₹1,500', savingLabel: 'Per Referral',
    badge: 'Ongoing', bg: '#1A1A1A',
...
function OfferCard({ offer, index }) {
  ...
  const isRed = offer.bg === '#CC0000' || offer.bg === '#8B0000';
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 4,
        overflow: 'hidden',
        border: hov ? '1px solid #CC0000' : '1px solid #E0E0E0',
        boxShadow: hov ? '0 12px 40px rgba(204,0,0,0.10), 0 2px 8px rgba(0,0,0,0.06)' : '0 2px 12px rgba(0,0,0,0.05)',
        opacity: vis ? 1 : 0,
    ...
    >
      {/* Top accent bar */}
      <div style={{ height: 3, background: offer.bg }} />
      ...
      <div style={{ padding: '24px 24px 20px', borderBottom: '1px solid #F0F0F0', background: '#FAFAFA' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
          <div style={{
            ...
            fontSize: 22, fontWeight: 600, color: '#fff', letterSpacing: '-1px',
          }}>
            {offer.icon}
          </div>
          <span style={{
      ...
      {/* Saving strip */}
      <div style={{ background: offer.bg, padding: '12px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <div style={{ padding: '20px 24px 24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 18 }}>
          <div style={{ width: 5, height: 5, borderRadius: '50%', background: offer.bg }} />
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 500, color: '#888' }}>{offer.validity}</span>
        </div>
        ...
        <div style={{ marginBottom: 20, borderTop: '1px solid #F0F0F0', paddingTop: 14 }}>
          <button
            ...
            onMouseEnter={e => e.currentTarget.style.color = offer.bg}
          ...
          <div style={{
            ...
            {offer.terms.map((t, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: 7 }}>
                ...
                <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: '#888', lineHeight: 1.6 }}>{t}</span>
              </div>
            ))}
          </div>
        </div>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-active .hero-h1-inner:nth-child(3) { transition-delay: 0.38s; }
        ...
        @media (min-width: 641px) and (max-width: 960px) {
          ...
          .hero-h1 { font-size: clamp(48px, 8vw, 80px) !important; }
        }
      `}</style>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 1100, margin: '0 auto' }}>
          ...
          <h1 className="hero-h1" style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 'clamp(44px, 7.5vw, 96px)', fontWeight: 600, lineHeight: 0.92, letterSpacing: '-0.02em', marginBottom: 28 }}>
            <div className="hero-h1-line"><span className="hero-h1-inner">SAVE BIG ON</span></div>
            <div className="hero-h1-line"><span className="hero-h1-inner" style={{ color: '#CC0000' }}>YOUR DREAM</span></div>
            <div className="hero-h1-line"><span className="hero-h1-inner">HERO BIKE</span></div>
          </h1>
          ...
          <p className="hero-sub" style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, fontWeight: 400, color: 'rgba(255,255,255,0.60)', maxWidth: 460, lineHeight: 1.7, marginBottom: 44 }}>
            Exchange bonus, zero down payment, direct cashback & more — curated deals at your nearest showroom.
          </p>

          {/* Countdown */}
          <div className="hero-timer" style={{ display: 'inline-flex', flexDirection: 'column', gap: 12 }}>
            <span style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.35)', letterSpacing: '0.18em', textTransform: 'uppercase' }}>Offers expire in</span>
            <div style={{ display: 'flex', gap: 0, alignItems: 'stretch' }}>
              {[['d', 'Days'], ['h', 'Hrs'], ['m', 'Min'], ['s', 'Sec']].map(([key, label], i) => (
                <div key={key} style={{ display: 'flex', alignItems: 'stretch' }}>
                  {i > 0 && (
                    <div style={{ display: 'flex', alignItems: 'center', padding: '0 4px', fontFamily: "'Rajdhani', sans-serif", fontSize: 22, color: 'rgba(255,255,255,0.2)', fontWeight: 300 }}>:</div>
                  )}
                  <div style={{
                    ...
                    <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 36, fontWeight: 700, color: '#CC0000', lineHeight: 1 }} className="ticker-num">{timeLeft[key]}</div>
      ...
      <section style={{ background: '#111', borderTop: '3px solid #CC0000', padding: 'clamp(48px, 8vw, 72px) 5vw' }}>
        <div className="banner-inner" style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 40, flexWrap: 'wrap' }}>
          <div>
            <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 11, fontWeight: 600, color: '#CC0000', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 12 }}>
              — Need Help?
            </div>
            <h2 style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 'clamp(28px, 5vw, 52px)', fontWeight: 600, color: '#fff', lineHeight: 0.95, letterSpacing: '-0.02em', marginBottom: 14 }}>
              Find the Right Offer<br />for Your Budget
            </h2>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 400, color: 'rgba(255,255,255,0.45)', maxWidth: 400, lineHeight: 1.7 }}>
              Our team will help you stack the best deals and get maximum savings on your Hero purchase.
            </p>
          </div>

          <div className="banner-buttons" style={{ display: 'flex', flexDirection: 'column', gap: 12, minWidth: 260 }}>
            <a href="tel:+918650442200" className="banner-btn" style={{
              display: 'flex', alignItems: 'center', gap: 16,
              padding: '16px 24px', background: '#CC0000', borderRadius: 3, textDecoration: 'none',
            ...
            >
              ...
              <div>
                <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.55)', letterSpacing: '0.14em', textTransform: 'uppercase' }}>Call Now</div>
                <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 22, fontWeight: 700, color: '#fff', lineHeight: 1.1 }}>+91 86504 42200</div>
              </div>
            </a>

            <a href="https://wa.me/918650442200" target="_blank" rel="noopener noreferrer" className="banner-btn" style={{
              display: 'flex', alignItems: 'center', gap: 16,
              padding: '16px 24px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 3, textDecoration: 'none',
            ...
            >
              ...
              <div>
                <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.35)', letterSpacing: '0.14em', textTransform: 'uppercase' }}>WhatsApp Us</div>
                <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 22, fontWeight: 700, color: '#fff', lineHeight: 1.1 }}>Chat Instantly</div>
              </div>
            </a>
          </div>
        </div>
